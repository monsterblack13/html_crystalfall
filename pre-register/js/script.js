...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        th: {
            ...
            'ctf-rewards-notice': 'รางวัลจะส่งผ่านอีเมล์ที่ลงทะเบียนล่วงหน้า ให้แก่ผู้ที่ลงทะเบียนล่วงหน้าและกด wishlist เท่านั้น<br>ผู้เล่นที่ Wishlist เกม Crystalfall บน Steam แล้ว เพียงลงทะเบียนล่วงหน้าเท่านั้น',
