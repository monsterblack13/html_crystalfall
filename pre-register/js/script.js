...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'ctf-trailer-description': 'Kickstart your adventure in a free to play online action RPG, featuring randomized dungeons, procedural skills, and an endless endgame set in a steampunk world.',
            'ctf-footer-subtitle': "CLASSIC ARPG<br>WITH ENDLESS BUILD DIVERSITY",
            'register-banner': 'Registered:',
            ...
            'ctf-rewards-notice': 'Rewards will be sent via redeem code to the pre-registration email at the Early Access launch and are available only to pre-registered and wishlisted players. Players who have already wishlisted Crystalfall on Steam only need to pre-register.<br>The campaign ends when Early Access launches.',
        ...
        th: {
            ...
            'ctf-nav-support': 'แจ้งปัญหา',
            'ctf-head-text': 'CLASSIC ARPG<br>WITH ENDLESS BUILD DIVERSITY',
            'ctf-class-character': 'คลาส / ตัวละคร',
            'ctf-class-description': 'เลือกคลาสที่ใช่ แล้วเอาชีวิตรอดในโลก steampunk ที่ถูกทำลายโดยอุกกาบาตปริศนา ต่อสู้กับศัตรู และล่าไอเทมสุดแรร์แบบออนไลน์ เล่นฟรี!',
            ...
            'ctf-trailer-description': 'เริ่มต้นการผจญภัยของคุณในเกม Action RPG ออนไลน์แบบ Free-to-Play ที่มาพร้อมดันเจี้ยนแบบสุ่ม สกิลที่สร้างแบบสุ่มตามระบบ (procedural) และ end game ที่ไม่มีที่สิ้นสุดในโลก steampunk',
            'ctf-footer-subtitle': 'CLASSIC ARPG<br>WITH ENDLESS BUILD DIVERSITY',
            'register-banner': 'จำนวนผู้ลงทะเบียน:',
            'ctf-reward-description': 'รางวัลจะปลดล็อกตามจำนวนผู้เล่นที่ลงทะเบียนล่วงหน้าและกด wishlist เกมใน Steam',
            'ctf-rewards-notice': 'รางวัลจะถูกส่งผ่านอีเมลที่ใช้ลงทะเบียนล่วงหน้าเมื่อเกมเปิด Early Access สำหรับผู้ที่ลงทะเบียนล่วงหน้าและกด Wishlist เท่านั้น สำหรับผู้เล่นที่กด Wishlist เกม Crystalfall บน Steam แล้ว เพียงลงทะเบียนล่วงหน้าเพิ่มเติม<br>แคมเปญจะสิ้นสุดเมื่อเปิด Early Access',
        ...
        id: {
            ...
            'ctf-trailer-description': 'Mulai petualanganmu dalam action RPG online yang gratis dimainkan, dengan dungeon acak, keterampilan prosedural, dan permainan akhir tanpa batas yang berlatar dunia steampunk.',
            'ctf-footer-subtitle': 'CLASSIC ARPG<br>WITH ENDLESS BUILD DIVERSITY',
            ...
            'ctf-rewards-notice': 'Hadiah akan dikirimkan dalam bentuk redeem code ke email yang digunakan saat pre-registrasi pada saat peluncuran Early Access, dan hanya tersedia bagi pemain yang telah melakukan pre-registrasi serta menambahkan Crystalfall ke Wishlist. Pemain yang sudah menambahkan Crystalfall ke Steam Wishlist hanya perlu melakukan pre-registrasi.<br>Program ini akan berakhir saat Early Access dimulai.',
    ...
    const linkTranslations = {
        ...
        'ctf-nav-support': {
            en: 'https://playpark.com/support-crystalfall/',
            th: 'https://playpark.com/support-crystalfall/',
            id: 'https://playpark.com/support-crystalfall/'
        }
    };
